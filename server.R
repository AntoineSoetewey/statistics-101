server <- function(input, output, session) {
  output$results_distribution <- renderUI({
    if (input$distribution == "Beta") {
      tagList(
        withMathJax(paste0("\\(X \\sim Beta(\\alpha = \\)", " ", input$alpha_beta, ", ", "\\(\\beta = \\)", " ", input$beta_beta, "\\()\\)")),
        br(),
        withMathJax(case_when(
      ...
      tagList(
        withMathJax(paste0("\\(X \\sim Bin(n = \\)", " ", input$n_binomial, ", ", "\\(p = \\)", " ", input$p_binomial, "\\()\\)")),
        br(),
        withMathJax(case_when(
      ...
      tagList(
        withMathJax(paste0("\\(X \\sim Cauchy(x_0 = \\)", " ", input$location_cauchy, ", ", "\\(\\gamma = \\)", " ", input$scale_cauchy, "\\()\\)")),
        br(),
        withMathJax(case_when(
      ...
      tagList(
        withMathJax(paste0("\\(X \\sim \\chi^2(df = \\)", " ", input$df_chisquare, "\\()\\)")),
        br(),
        withMathJax(case_when(
      ...
      tagList(
        withMathJax(paste0("\\(X \\sim Exp(\\lambda = \\)", " ", input$rate_exponential, "\\()\\)")),
        br(),
        withMathJax(case_when(
      ...
      tagList(
        withMathJax(paste0("\\(X \\sim F(df_1 = \\)", " ", input$df1_fisher, ", ", "\\(df_2\\)", " = ", input$df2_fisher, "\\()\\)")),
        br(),
        withMathJax(case_when(
          ...
          input$lower_tail_fisher == "interval" ~ paste0("\\(P(\\)", input$a_fisher, " ", "\\(\\leq X\\leq \\)", " ", input$b_fisher, "\\()\\)", " ", "\\( = \\)", " ", ifelse(input$a_fisher > input$b_fisher, "a must be less than or equal to b", round(pf(input$b_fisher, df1 = input$df1_fisher, df2 = input$df2_fisher, lower.tail = TRUE) - pf(input$a_fisher, df1 = input$df1_fisher, df2 = input$df2_fisher, lower.tail = TRUE), 4)))
        ))
      )
    } else if (input$distribution == "Gamma") {
      tagList(
        withMathJax(paste0("\\(X \\sim Gamma(\\alpha = \\)", " ", input$alpha_gamma, ", ", "\\(\\beta = \\)", " ", input$beta_gamma, "\\()\\)")),
        br(),
        withMathJax(case_when(
      ...
      tagList(
        withMathJax(paste0("\\(X \\sim Geom(p = \\)", " ", input$p_geometric, "\\()\\)")),
        br(),
        withMathJax(case_when(
      ...
      tagList(
        withMathJax(paste0("\\(X \\sim Geom(p = \\)", " ", input$p_geometric2, "\\()\\)")),
        br(),
        withMathJax(case_when(
      ...
      tagList(
        withMathJax(paste0("\\(X \\sim HG(n = \\)", " ", input$n_hypergeometric, ", ", "\\(N = \\)", " ", input$N_hypergeometric, ", ", "\\(M = \\)", " ", input$M_hypergeometric, "\\()\\)")),
        br(),
        withMathJax(case_when(
      ...
      tagList(
        withMathJax(paste0("\\(X \\sim Logi(\\mu = \\)", " ", input$location_logistic, ", ", "\\(s = \\)", " ", input$scale_logistic, "\\()\\)")),
        br(),
        withMathJax(case_when(
      ...
      tagList(
        withMathJax(paste0("\\(X \\sim Lognormal(\\mu = \\)", " ", input$mean_lognormal, ", ", ifelse(input$variance_sd_lognormal == "variance_true", paste0("\\(\\sigma^2 = \\)", " ", input$variance_lognormal), paste0("\\(\\sigma^2 = \\)", " ", input$sd_lognormal^2)), "\\()\\)")),
        br(),
        withMathJax(case_when(
      ...
      tagList(
        withMathJax(paste0("\\(X \\sim NG(r = \\)", " ", input$r_negativebinomial, ", ", "\\(p = \\)", " ", input$p_negativebinomial, "\\()\\)")),
        br(),
        withMathJax(case_when(
      ...
      tagList(
        withMathJax(paste0("\\(X \\sim NG(r = \\)", " ", input$r_negativebinomial2, ", ", "\\(p = \\)", " ", input$p_negativebinomial2, "\\()\\)")),
        br(),
        withMathJax(case_when(
      ...
      tagList(
        withMathJax(paste0("\\(X \\sim N(\\mu = \\)", " ", input$mean_normal, ", ", ifelse(input$variance_sd == "variance_true", paste0("\\(\\sigma^2 = \\)", " ", input$variance_normal), paste0("\\(\\sigma^2 = \\)", " ", input$sd_normal^2)), "\\()\\)")),
        br(),
        withMathJax(case_when(
      ...
      tagList(
        withMathJax(paste0("\\(X \\sim Pois(\\lambda = \\)", " ", input$lambda_poisson, "\\()\\)")),
        br(),
        withMathJax(case_when(
      ...
      tagList(
        withMathJax(paste0("\\(X \\sim St(df = \\)", " ", input$df_student, "\\()\\)")),
        br(),
        withMathJax(case_when(
      ...
      tagList(
        withMathJax(paste0("\\(X \\sim Weibull(\\alpha = \\)", " ", input$alpha_weibull, ", ", "\\(\\beta = \\)", " ", input$beta_weibull, "\\()\\)")),
        br(),
        withMathJax(case_when(
